 ...
 * using adaptive Gauss-Lobatto quadrature.使用自适应Gauss-Lobatto积分来计算一维函数的积分
 *
...
protected:
	 ...
	 *
	 * \param f Function to integrate积分函数
	 * \param a Lower integration limit积分下限
	 * \param b Upper integration limit积分上限
